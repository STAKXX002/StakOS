...
The `i686-elf-gcc` cross compiler is not typically available in the Ubuntu repositories. This project uses the same Homebrew package as the GitHub Actions CI workflow.
